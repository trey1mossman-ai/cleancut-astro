...
|------|------|-------|-------|-------|
| Colleen Hayes | Owner/Primary Contact | colleen@cleancutservice.com | - | Decision maker. Warm, responsive. Provides detailed feedback. |

## Communication

### Primary Contact
**Colleen Hayes** - Single point of contact. She handles all decisions and provides content/assets.

### Style
- **Tone:** Warm, friendly
- **Format:** Email preferred, comfortable with video calls
- **Response time:** Very responsive - often same day
- **Timezone:** Central Time (CT) - 1 hour ahead of MST

### Sign-off to use
Thanks, / Warm regards,

## Decision Making
- **All decisions:** Colleen Hayes (sole owner/contact)

## Project History

### Timeline
- **Dec 23, 2025:** Colleen sent Google Doc with updated copy, CTA suggestions, notes
- **Dec 27, 2025:** Shared additional assets
...
- FAQs - need client input on answers
- Videos from live gallery page
...
| Role | Person |
|------|--------|
| Website Development | Trey Mossman |
